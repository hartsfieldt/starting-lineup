...
<div class="card mt-5" style="width: 18rem;">
    <div class="card-body">
        ...
        <a href="mailto:${manager.getEmail()}" target="_blank" class="card-link">${engineer.getEmail()}</a>
...
<div class="card mt-5" style="width: 18rem;">
    <div class="card-body">
        ...
        <a href="mailto:${manager.getEmail()}" target="_blank" class="card-link">${intern.getEmail()}</a>
